...
export class PlayerPropertiesView extends UI.Widget.VBox {
    ...
    populateAttributesAndElements() {
        ...
        this._attributeMap.set("kResolution" /* kResolution */, resolution);
        ...
        this._attributeMap.set("kVideoDecoderName" /* kVideoDecoderName */, decoderName);
        ...
        this._attributeMap.set("kIsPlatformVideoDecoder" /* kIsPlatformVideoDecoder */, videoPlatformDecoder);
        ...
        this._attributeMap.set("kVideoEncoderName" /* kVideoEncoderName */, encoderName);
        ...
        this._attributeMap.set("kIsPlatformVideoEncoder" /* kIsPlatformVideoEncoder */, videoPlatformEncoder);
        const videoDDS = new PropertyRenderer(i18nString(UIStrings.decryptingDemuxer));
        this._videoDecoderElements.push(videoDDS);
        this._attributeMap.set("kIsVideoDecryptingDemuxerStream" /* kIsVideoDecryptingDemuxerStream */, videoDDS);
        const videoTrackManager = new VideoTrackManager(this);
        this._attributeMap.set("kVideoTracks" /* kVideoTracks */, videoTrackManager);
        ...
        this._attributeMap.set("kAudioDecoderName" /* kAudioDecoderName */, audioDecoder);
        ...
        this._attributeMap.set("kIsPlatformAudioDecoder" /* kIsPlatformAudioDecoder */, audioPlatformDecoder);
        const audioDDS = new PropertyRenderer(i18nString(UIStrings.decryptingDemuxer));
        this._audioDecoderElements.push(audioDDS);
        this._attributeMap.set("kIsAudioDecryptingDemuxerStream" /* kIsAudioDecryptingDemuxerStream */, audioDDS);
        const audioTrackManager = new AudioTrackManager(this);
        this._attributeMap.set("kAudioTracks" /* kAudioTracks */, audioTrackManager);
