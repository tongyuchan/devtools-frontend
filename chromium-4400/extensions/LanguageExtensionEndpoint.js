...
export class LanguageExtensionEndpoint extends Bindings.DebuggerLanguagePlugins.DebuggerLanguagePlugin {
    ...
    evaluateVariable(name, location) {
        return /** @type {!Promise<?Bindings.DebuggerLanguagePlugins.EvaluatorModule>}*/ (this._sendRequest(this._commands.EvaluateVariable, { name, location }));
    }
    ...
    getTypeInfo(expression, context) {
        return /** @type {!Promise<?{typeInfos: !Array<!Bindings.DebuggerLanguagePlugins.TypeInfo>, base: !Bindings.DebuggerLanguagePlugins.EvalBase}>} */ (this._sendRequest(this._commands.GetTypeInfo, { expression, context }));
    }
    /**
     * @override
