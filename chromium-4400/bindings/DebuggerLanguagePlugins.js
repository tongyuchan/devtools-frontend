...
class FormattedValueNode extends SDK.RemoteObject.RemoteObjectImpl {
    ...
    async _createRemoteObject(newObject) {
        ...
        if (!base) {
            return new FormattedValueNode(this._callFrame, this._sourceType, this._plugin, newObject, this.formatterTag, this._evalOptions);
        }
    ...
    async _getEvalBaseFromObject(object) {
        ...
        const baseObject = new FormattedValueNode(this._callFrame, this._sourceType, this._plugin, result, null, this._evalOptions);
...
class StaticallyTypedValueNode extends SDK.RemoteObject.RemoteObjectImpl {
    ...
    async _expandMember(sourceType, fieldInfo) {
        if (sourceType.typeInfo.hasValue && !sourceType.typeInfo.canExpand && this._base) {
            return formatSourceValue(this._callFrame, this._plugin, sourceType, this._base, this._fieldChain.concat(fieldInfo), this._evalOptions);
        }
        return new StaticallyTypedValueNode(this._callFrame, this._plugin, sourceType, this._base, this._fieldChain.concat(fieldInfo), this._evalOptions);
    }
    /**
     * @override
