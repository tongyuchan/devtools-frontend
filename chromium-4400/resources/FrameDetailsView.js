...
export class FrameDetailsView extends UI.ThrottledWidget.ThrottledWidget {
    ...
    _updateApiAvailability() {
        ...
        UI.Tooltip.Tooltip.install(this._apiMeasureMemory, measureMemoryAvailable ? ls `The performance.measureUserAgentSpecificMemory() API is available` :
        ...
        this._apiMeasureMemory.appendChild(UI.Fragment.html `<div>${status} ${UI.XLink.XLink.create(link, ls `Learn more`)}</div>`);
    }
