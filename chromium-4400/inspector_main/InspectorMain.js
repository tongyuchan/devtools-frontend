...
export class InspectorMainImpl extends Common.ObjectWrapper.ObjectWrapper {
    ...
    async run() {
        ...
        await SDK.Connections.initMainConnection(async () => {
            ...
            const target = SDK.SDKModel.TargetManager.instance().createTarget('main', Common.UIString.UIString('Main'), type, null, undefined, waitForDebuggerInPage);
...
export class NodeIndicator {
    constructor() {
        ...
        SDK.SDKModel.TargetManager.instance().addEventListener(SDK.SDKModel.Events.AvailableTargetsChanged, event => this._update(/** @type {!Array<!Protocol.Target.TargetInfo>} */ (event.data)));
