        ...
        for (let i = 0; i < events.length; ++i) {
            ...
            switch (type) {
                ...
                case eventTypes.FlingStart:
                    if (flingStart) {
                        Common.Console.Console.instance().error(Common.UIString.UIString('Two flings at the same time? %s vs %s', flingStart.startTime, event.startTime));
                        break;
                    }
                    flingStart = event;
                    break;
                ...
                case eventTypes.TouchStart:
                    ...
                    if (touchStart) {
                        Common.Console.Console.instance().error(Common.UIString.UIString('Two touches at the same time? %s vs %s', touchStart.startTime, event.startTime));
                        break;
                    }
                    touchStart = event;
