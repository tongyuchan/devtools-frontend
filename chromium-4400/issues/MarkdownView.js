...
const tokenRenderers = new Map([
    ...
    [
        'link',
        (token) => html `<devtools-markdown-link .data=${{ key: token.href, title: token.text }}></devtools-markdown-link>`,
    ],
    [
        'image',
        (token) => html `<devtools-markdown-image .data=${{ key: token.href, title: token.text }}></devtools-markdown-image>`,
    ],
]);
// TODO(crbug.com/1108699): Fix types when they are available.
// eslint-disable-next-line @typescript-eslint/no-explicit-any
