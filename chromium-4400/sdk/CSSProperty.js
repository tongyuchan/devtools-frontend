...
export class CSSProperty {
    ...
    async setText(propertyText, majorChange, overwrite) {
        ...
        /** @type {!TextUtils.TextUtils.TokenizerFactory} */ (await /** @type {!Root.Runtime.Extension} */ (Root.Runtime.Runtime.instance().extension(TextUtils.TextUtils.TokenizerFactory))
            .instance());
