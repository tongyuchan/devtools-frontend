    ...
    static codeForSameSiteDetails(reason, warningReasons, operation, cookieUrl) {
        ...
        if (reason === Protocol.Audits.SameSiteCookieExclusionReason.ExcludeSameSiteStrict ||
            ...
            if (warningReasons && warningReasons.length > 0) {
                ...
                if (warningReasons.includes(Protocol.Audits.SameSiteCookieWarningReason.WarnSameSiteStrictCrossDowngradeStrict) ||
 ...
 */
const schemefulSameSiteArticles = [{ link: 'https://web.dev/schemeful-samesite/', linkTitle: ls `How Schemeful Same-Site Works` }];
/**
