...
export class TimelinePaintProfilerView extends UI.SplitWidget.SplitWidget {
    ...
    _update() {
        ...
        if (this._pendingSnapshot) {
            ...
            const picture = /** @type {!SDK.TracingModel.ObjectSnapshot} */ (TimelineModel.TimelineModel.TimelineData.forEvent(this._event).picture);
            snapshotPromise = picture.objectPromise()
                .then(data => /** @type {!SDK.PaintProfiler.PaintProfilerModel} */ (this._paintProfilerModel)
